...
fname = [fpath, 'N12_Jx0.8_Jy0.8_Jz1_hx0_hz0.2_Ttot8_Ns8192_coe0.3_DepMax64_echo_Ideal.mat'];
load(fname)
...
% load([fpath, 'N12_Jx1.05_Jy1.0_Jz0.7_hx0_hz0.2_Ttot5_coe0.4_DepMax30_echo_',suf,'.mat']) 
 ...
 suf = 'Case1_fhkg';
fname = [fpath, 'N12_Jx0.8_Jy0.8_Jz1_hx0_hz0.2_Ttot8_coe0.3_DepMax64_echo_',suf,'.mat'];
load(fname) 
...
range1 = (find(Ej_ls<-1.4583));
range2 = (find(Ej_ls>-1.4583 & Ej_ls<-1.3333));
...
xlim([Ej_ls(dex1)-0.02,Ej_ls(dex1)+0.01]);
ylim([0.020, 0.04])
% ylim([0.024, 0.0305])
...
print(gcf, '-dpdf','-r600', ['Case1_N12_FinerGrid_',suf_save,'.pdf']);
...
xlim([Ej_ls(dex2)-0.02,Ej_ls(dex2)+0.02]);
ylim([0.020, 0.04])
...
print(gcf, '-dpdf','-r600', ['Case1_N12_Ns1024_',suf,'.pdf']);
